...
exports.handler = async (event) => {
    ...
    try {
        ...
        // 1. Отправка заказа с сайта в Telegram
        ...
        // 2. Обработка нажатий на кнопки в Telegram
        if (data.callback_query) {
            ...
            if (callback.data === "accept_order") {
                ...
                await sendTelegram('editMessageText', {
                    ...
                    reply_markup: {
                        inline_keyboard: [
                            [{ text: "🏁 Завершить заказ", callback_data: "complete_order" }]
                        ]
                    }
                });
                ...
                const completedText = message.text + `\n\n🎉 <b>Заказ выполнен!</b>`;
